...
def build_configs(args: argparse.Namespace) -> Tuple[AdapterConfig, TrainingConfigV2]:
    ...
    train_cfg = TrainingConfigV2(
        ...
        training_mode=getattr(args, "training_mode", "adapter"),
        full_train_include=getattr(args, "full_train_include", "decoder"),
        full_lr_mult_attn=getattr(args, "full_lr_mult_attn", 1.0),
        full_lr_mult_ffn=getattr(args, "full_lr_mult_ffn", 1.0),
        full_lr_mult_other=getattr(args, "full_lr_mult_other", 1.0),
        length_bucket=getattr(args, "length_bucket", False),
        cache_policy=getattr(args, "cache_policy", "none"),
        cache_max_items=getattr(args, "cache_max_items", 0),
